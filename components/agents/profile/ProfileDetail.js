          ...
          <Media className="contact-media">
            ...
            <Media body>
              ...
              <ul className="agent-social mt-2">
                ...
                <li>
                  <Link href="https://account.google.com" className="google">
          ...
          <div className="all-properties mt-3">
            <ul className="light-box user-info-icon">
              ...
              <li>
                <Media>
                  <img
                    src="/assets/images/svg/icon/3.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Media body>
              ...
              <li>
                <Media>
                  <img
                    src="/assets/images/svg/icon/2.png"
                    className="img-fluid"
                    alt=""
                  />
                  <Media body>
